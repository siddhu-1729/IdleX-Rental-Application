...
export const RENTER_SIDEBAR: Array<{ label: string; href: string; icon: string; badge?: number | string }> = [
  ...
  { label: "My Bookings", href: ROUTES.MY_RENTALS, icon: "CalendarCheck", badge: "3" },
  { label: "Extension Requests", href: `${ROUTES.MY_RENTALS}?tab=extensions`, icon: "Repeat", badge: 1 },
  { label: "My Payments", href: ROUTES.PAYMENTS, icon: "Wallet" },
  { label: "Wishlist", href: ROUTES.WISHLIST, icon: "Heart" },
  { label: "Messages", href: ROUTES.MESSAGES, icon: "MessageCircle", badge: 2 },
